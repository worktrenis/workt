...
export const CCNL_STANDBY_RATES = {
  ...
  GROUP_L1_3: { 
    ...
    weekly6Days: { six: 37.48, sixWithHoliday: 38.17, sixWithHolidayAndRest: 41.09 }
  },
  GROUP_L4_5: { 
    feriale16: 6.87, feriale24: 10.77, festivo24: 11.56,
    weekly6Days: { six: 45.10, sixWithHoliday: 45.88, sixWithHolidayAndRest: 49.79 }
  },
  GROUP_SUPER_5: { 
    feriale16: 7.89, feriale24: 12.98, festivo24: 13.66, // livelli 6-9
    weekly6Days: { six: 52.45, sixWithHoliday: 53.12, sixWithHolidayAndRest: 58.21 }
  },
};
